...
displacement_wheel_front = data.InputFront(5);%[in]
displacement_wheel_rear = data.InputRear(5);%[in]
...
k_ride_front = LLT_front/displacement_wheel_front;%inputs[lbs, inch] output[lbs/in]
k_ride_rear = LLT_rear/displacement_wheel_rear;
...
disp(['Total Laterl Load Distribution at Front: ', num2str(TLLTD_front)])

%calculate new wheel displacements
displacement_wheel_front = LLT_front/k_ride_front;%inputs[lbs, lbs/in] output[in]
displacement_wheel_rear = LLT_rear/k_ride_rear;
...
if (displacement_wheel_front > 2.05 || displacement_wheel_front < 0.95)|| (displacement_wheel_rear > 2.05 || displacement_wheel_rear < 0.95)
